...
// CRIMSON EDIT START - Armory Ammunition Additions - Eventually wanna lock these behind high streetwise skill, can lower prices then
		...
		new /datum/data/vending_product(".50 BMG raufoss ammo", /obj/item/ammo_box/darkpack/c50/rauf, 6500),
		new /datum/data/vending_product("12g HE slugs", /obj/item/ammo_box/darkpack/c12g/he, 5000),
